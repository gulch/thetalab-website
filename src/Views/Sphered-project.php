...
<div id=work>
    <div class=container>
        <div class="sixteen columns">
            <div class=project-logo><img src=/imagez/clients/5.png></div>
            <div id=cbp-fwslider class=cbp-fwslider>
                <ul>
                    <li><img src=/imagez/works/501.jpg alt="Sphered site development"></li>
                    <li><img src=/imagez/works/502.jpg alt="Sphered logic development"></li>
                    <li><img src=/imagez/works/503.jpg alt="Sphered design"></li>
                    <li><img src=/imagez/works/504.jpg alt=Sphered></li>
                    <li><img src=/imagez/works/505.jpg alt="Sphered seo"></li>
                    <li><img src=/imagez/works/506.jpg alt="Sphered VR"></li>
                    <li><img src=/imagez/works/507.jpg alt="Sphered blog"></li>
                </ul>
            </div>
        </div>
        <div class="twelve columns"><h6>Sphered project</h6>

            <p>New modern website for Sphered project. Full development service packet. Branding. SEO optimization. 3D Photo Services</p>

            <p><a class=inner-button-works target=_blank href="http://sphered.com.ua/">View</a></p></div>
