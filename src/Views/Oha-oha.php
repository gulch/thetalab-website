...
<div id=work>
    <div class=container>
        <div class="sixteen columns">
            <div class=project-logo><img src=/img/clients/7.png></div>
            <div id=cbp-fwslider class=cbp-fwslider>
                <ul>
                    <li><img src=/img/works/701.jpg alt="Oha oha website"></li>
                    <li><img src=/img/works/702.jpg alt="Oha-Oha site logic development"></li>
                    <li><img src=/img/works/703.jpg alt="Oha-Oha site dev"></li>
                    <li><img src=/img/works/704.jpg alt=oha-oha.com.ua></li>
                </ul>
            </div>
        </div>
        <div class="twelve columns">
            <h6>Oha-Oha! - open people community</h6>
            <p>Full development service packet. Branding. SEO optimization. Blogging Support</p>
            <p><a class=inner-button-works target=_blank href="http://oha-oha.com.ua/">View</a></p>
        </div>
