...
<div id=work>
    <div class=container>
        <div class="sixteen columns">
            <div class=project-logo><img src=/imagez/clients/1.png></div>
            <div id=cbp-fwslider class=cbp-fwslider>
                <ul>
                    <li><img src=/imagez/works/301.jpg alt="Новый формат"></li>
                    <li><img src=/imagez/works/302.jpg alt="Новый формат"></li>
                    <li><img src=/imagez/works/303.jpg alt="Новый формат"></li>
                    <li><img src=/imagez/works/304.jpg alt="Новый формат"></li>
                </ul>
            </div>
        </div>
        <div class="twelve columns"><h6>NFK.IN.UA - new modern site for company "Novy Format"</h6>

            <p>New modern site that represents about full range of services company "Noviy Format" located in Ukrane,
                Kiev, Zapadinskaya str., 5. Full development service packet. Branding. Photo.</p>

            <p><a class=inner-button-works target=_blank href="http://nfk.in.ua/">View</a></p></div>
